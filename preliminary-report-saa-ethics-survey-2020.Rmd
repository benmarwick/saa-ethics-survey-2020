...
```{r what-type-document-by-years-plot, fig.cap="Distribution of responses to the question 'hat type of ethical document(s) do you feel would best serve the SAA membership?' by years worked in archaeology", fig.height=8}
